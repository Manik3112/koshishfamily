...
<head>
    ...
    <title>Koshish Family - Koshish Art & Craft</title>
  ...
  <div class="container">
    <div class="row align-items-center text-white">
      ...
      <div class="col-md-6 intros text-start">
        <h1 class="display-2">
          <span class="display-2--intro">Koshish Art & Craft</span>
        </h1>
  ...
  <section id="campanies" class="campanies">
    <div class="container">
      <div class="row text-center">
        <h4 class="fw-bold lead mb-3">Some </h4>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
            <img src="images/department/art-and-craft/graph.png" alt="Campany 1 logo" title="Campany 1 Logo" class="img-fluid">
        </div>
      </div>
    </div>
  </section>
