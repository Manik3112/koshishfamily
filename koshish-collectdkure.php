...
<head>
    ...
    <meta name="title" content="Koshish Family - Koshish CollectDKure">
    ...
    <title>Koshish Family - Koshish CollectDKure</title>
...
<nav class="navbar navbar-expand-lg navbar-dark menu shadow fixed-top">
    <div class="container">
      <a class="navbar-brand" href="">
        <img src="images/arts/logo.png" height="50px" alt="logo image"><b>Koshish Family</b>
      </a>
  ...
  <div class="container">
    <div class="row align-items-center text-white">
      ...
      <div class="col-md-6 intros text-start">
        <h1 class="display-2">
          <span class="display-2--intro">Koshish CollectDKure</span>
        </h1>
        <a href="#contact" style="text-decoration: none;">
          <button type="button" class="rounded-pill btn-rounded">Get in Touch with the team
      ...
      <div class="col-md-6 intros text-end">
        <div class="video-box">
          <img src="images/arts/logo.png" alt="video illutration" class="img-fluid">
        </div>
      </div>
    </div>
  </div>
  ...
  <section id="campanies" class="campanies">
    <div class="container">
      <div class="row text-center">
        <h4 class="fw-bold lead mb-3">Koshish Collection and Distribution Drive</h4>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
            <img src="images/department/collectdkure/graph.png" alt="Campany 1 logo" title="Campany 1 Logo" class="img-fluid">
        </div>
      </div>
    </div>
  </section>
