...
<head>
    ...
    <meta name="title" content="Koshish Family - Koshish Marketing">
    ...
    <title>Koshish Family - Koshish Marketing</title>
  ...
  <div class="container">
    <div class="row align-items-center text-white">
      ...
      <div class="col-md-6 intros text-start">
        <h1 class="display-2">
          <span class="display-2--intro">Koshish Marketing</span>
        </h1>
  ...
  <section id="campanies" class="campanies">
    <div class="container">
      <div class="row text-center">
        <h4 class="fw-bold lead mb-3">Koshish Social Media Reach Update</h4>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-lg-2">
            <img src="images/department/marketing/graph.png" alt="Campany 1 logo" title="Campany 1 Logo" class="img-fluid">
        </div>
      </div>
    </div>
  </section>
